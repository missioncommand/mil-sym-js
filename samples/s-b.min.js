...
line+=' stroke-width="2"';if(strokeOpacity&&strokeOpacity!==1.0)
...
line+=' fill="'+fill+'"';if(fillOpacity&&fillOpacity!==1.0)
...
{console.info(param);}}}}}};}());var armyc2=armyc2||{};armyc2.c2sd=armyc2.c2sd||{};armyc2.c2sd.renderer=armyc2.c2sd.renderer||{};armyc2.c2sd.renderer.utilities=armyc2.c2sd.renderer.utilities||{};armyc2.c2sd.renderer.utilities.MilStdAttributes=armyc2.c2sd.renderer.utilities.MilStdAttributes||{};armyc2.c2sd.renderer.utilities.MilStdAttributes.LineColor="LINECOLOR";armyc2.c2sd.renderer.utilities.MilStdAttributes.FillColor="FILLCOLOR";armyc2.c2sd.renderer.utilities.MilStdAttributes.IconColor="ICONCOLOR";armyc2.c2sd.renderer.utilities.MilStdAttributes.TextColor="TEXTCOLOR";armyc2.c2sd.renderer.utilities.MilStdAttributes.TextBackgroundColor="TEXTBACKGROUNDCOLOR";armyc2.c2sd.renderer.utilities.MilStdAttributes.Alpha="ALPHA";armyc2.c2sd.renderer.utilities.MilStdAttributes.LineWidth="LINEWIDTH";armyc2.c2sd.renderer.utilities.MilStdAttributes.PixelSize="SIZE";armyc2.c2sd.renderer.utilities.MilStdAttributes.KeepUnitRatio="KEEPUNITRATIO";armyc2.c2sd.renderer.utilities.MilStdAttributes.SymbologyStandard="SYMSTD";armyc2.c2sd.renderer.utilities.MilStdAttributes.Icon="ICON";armyc2.c2sd.renderer.utilities.MilStdAttributes.LookAtTag="LOOKAT";armyc2.c2sd.renderer.utilities.MilStdAttributes.AltitudeMode="ALTMODE";armyc2.c2sd.renderer.utilities.MilStdAttributes.UseDashArray="USEDASHARRAY";armyc2.c2sd.renderer.utilities.MilStdAttributes.UsePatternFill="USEPATTERNFILL";armyc2.c2sd.renderer.utilities.MilStdAttributes.HideOptionalLabels="HIDEOPTIONALLABELS";armyc2.c2sd.renderer.utilities.MilStdAttributes.SVGFormat="SVGFORMAT";var armyc2=armyc2||{};armyc2.c2sd=armyc2.c2sd||{};armyc2.c2sd.renderer=armyc2.c2sd.renderer||{};armyc2.c2sd.renderer.utilities=armyc2.c2sd.renderer.utilities||{};armyc2.c2sd.renderer.utilities.RendererUtilities=(function(){var pastTextMeasurements={};var fullFontMeasurements={};var pastIdealOutlineColors={};var FillPatterns=armyc2.c2sd.renderer.utilities.FillPatterns||null;var _canvas=null;var _ctx=null;if(document&&document.createElement)
...
fullFontMeasurements[font]={widths:widths,height:height,descent:descent,fullHeight:fullHeight};pastTextMeasurements[font]={height:height,fullHeight:fullHeight,descent:descent};return fullFontMeasurements[font];}
else if(fontInfo)
{if(!fullFontMeasurements[font])
...
{_KMLLabelScale=1.0;}
var tempSize=Math.round(size*_KMLLabelScale);_MPModifierFont=style+" "+tempSize+"pt "+name;armyc2.c2sd.renderer.utilities.RendererUtilities.measureFont(_MPModifierFont,fontInfo);},getMPModifierFont:function(){return _MPModifierFont;},getMPModifierFontName:function(){return _MPModifierFontName;},getMPModifierFontSize:function(){return _MPModifierFontSize;},getMPModifierFontStyle:function(){return _MPModifierFontStyle;},getKMLLabelScale:function(){return _KMLLabelScale;},getFontInfo:function(){return{name:_ModifierFontName,size:_ModifierFontSize,style:_ModifierFontStyle,measurements:armyc2.c2sd.renderer.utilities.RendererUtilities.measureFont(_ModifierFont)};},getMPFontInfo:function(){return{name:_MPModifierFontName,size:_MPModifierFontSize,style:_MPModifierFontStyle,measurements:armyc2.c2sd.renderer.utilities.RendererUtilities.measureFont(_MPModifierFont)};},getInstance:function(){return armyc2.c2sd.renderer.utilities.RendererSettings;}};}());var armyc2=armyc2||{};armyc2.c2sd=armyc2.c2sd||{};armyc2.c2sd.renderer=armyc2.c2sd.renderer||{};armyc2.c2sd.renderer.utilities=armyc2.c2sd.renderer.utilities||{};armyc2.c2sd.renderer.utilities.SymbolUtilities={};armyc2.c2sd.renderer.utilities.SymbolUtilities.getBasicSymbolID=function(symbolID,symStd){var basic=symbolID;if(symbolID&&symbolID.length===15)
{var scheme=symbolID.charAt(0);if(scheme==='S'||scheme==='O'||scheme==='E')
{basic=scheme+'*'+basic.charAt(2)+'*'+basic.substring(4,10)+"*****";var i=symStd||0;for(;i<2;i++)
{var has=armyc2.c2sd.renderer.utilities.UnitDefTable.hasUnitDef(basic,i);var temp=null;if(has)
{i=3;}
else
{temp=basic.substr(0,10)+"H****";has=armyc2.c2sd.renderer.utilities.UnitDefTable.hasUnitDef(temp,i);if(has)
{basic=temp;i=3;}
else
{temp=basic.substr(0,10)+"MO***";has=armyc2.c2sd.renderer.utilities.UnitDefTable.hasUnitDef(temp,i);if(has)
{basic=temp;i=3;}}}}}
else if(scheme==='G')
...
else if(symbolID===("WA-DBALPNC--A--")||symbolID===("WA-DBALPC---A--")||symbolID===("WA-DIPID---L---")||symbolID===("WO-DHCF----L---")||symbolID===("WO-DHCF-----A--")||symbolID===("WO-DGMSIM---A--")||symbolID===("WO-DGMRS----A--")||symbolID===("WO-DGMCL----A--")||symbolID===("WO-DGMIBB---A--")||symbolID===("WO-DGMBCA---A--")||symbolID===("WAS-WSR-LIP----")||symbolID===("WAS-WSR-LCP----")||symbolID===("WAS-WSR-MIP----")||symbolID===("WAS-WSR-MCP----")||symbolID===("WAS-WSR-HIP----")||symbolID===("WAS-WSR-HCP----")||symbolID===("WAS-WSRSL-P----")||symbolID===("WAS-WSRSMHP----")||symbolID===("WAS-WSRST-P----")||symbolID===("WAS-WSD-LIP----")||symbolID===("WAS-WSD-LCP----")||symbolID===("WAS-WSD-MIP----")||symbolID===("WAS-WSD-MCP----")||symbolID===("WAS-WSD-HIP----")||symbolID===("WAS-WSD-HCP----")||symbolID===("WAS-WSM-L-P----")||symbolID===("WAS-WSM-MHP----")||symbolID===("WAS-WSMSL-P----")||symbolID===("WAS-WSMSMHP----")||symbolID===("WAS-WSS-LIP----")||symbolID===("WAS-WSS-LCP----")||symbolID===("WAS-WSS-MIP----")||symbolID===("WAS-WSS-MCP----")||symbolID===("WAS-WSS-HIP----")||symbolID===("WAS-WSS-HCP----")||symbolID===("WAS-WSSBLMP----")||symbolID===("WAS-WSSBH-P----")||symbolID===("WAS-WSSG--P----")||symbolID===("WAS-WSSSL-P----")||symbolID===("WAS-WSSSMHP----")||symbolID===("WAS-WSUKP-P----"))
...
return new armyc2.c2sd.renderer.utilities.Color(255,255,255);else if(symbolID===("WO-DHABP----A--")||symbolID===("WO-DHHD-----A--")||symbolID===("WO-DHHDD----A--")||symbolID===("WO-DMCC-----A--"))
{return new armyc2.c2sd.renderer.utilities.Color(0,0,255);}
else if(symbolID===("WO-DHPMD----A--"))
return new armyc2.c2sd.renderer.utilities.Color(188,153,58);else return null;};armyc2.c2sd.renderer.utilities.SymbolUtilities.getColorFromHexString=function(hexValue)
{var hexAlphabet="0123456789ABCDEF";if(hexValue.charAt(0)==='#')
hexValue=hexValue.substring(1);if(hexValue.substring(0,2)===("0x")||hexValue.substring(0,2)===("0X"))
hexValue=hexValue.substring(2);hexValue=hexValue.toUpperCase();var count=hexValue.length,value=null,k=0,int1=0,int2=0;if(count===8||count===6)
{value=[];for(var i=0;i<count;i+=2)
...
{}
return null;};armyc2.c2sd.renderer.utilities.SymbolUtilities.isTacticalGraphic=function(strSymbolID){if(strSymbolID&&((strSymbolID.charAt(0)===('G'))||(strSymbolID.charAt(0)===('W'))||this.isEMSNaturalEvent(strSymbolID)))
{return true;}
...
{symbols=spMappingXml.TACTICALGRAPHICS.SYMBOL;spMappingXml=null;symbolMap={};this.parser=null;count=symbols.length;for(i=0;i<count;i+=1){symbol=symbols[i];if(symbol!==null){data={};data.symbolID=symbol["SYMBOLID"]||"";data.mapping=symbol["MAPPING"]||"";data.description=symbol["DESCRIPTION"]||"";if(data.mapping!=="")
...
return center;};var armyc2=armyc2||{};armyc2.c2sd=armyc2.c2sd||{};armyc2.c2sd.renderer=armyc2.c2sd.renderer||{};armyc2.c2sd.renderer.TacticalGraphicIconRenderer=(function(){var fontSizeForTGIcons=60;return{getIcon:function(symbolID,size,color,alpha){var id=symbolID;if(armyc2.c2sd.renderer.utilities.SymbolUtilities.isWeather(symbolID)===true)
...
color=color.toHexString(false);var charSymbolIndex=armyc2.c2sd.renderer.utilities.TacticalGraphicLookup.getCharCodeFromSymbol(id);if(charSymbolIndex>=0)
...
render=modifiers["RENDER"];var newii=null,symbolBounds=ii.getSymbolBounds(),imageBounds=ii.getImageBounds(),centerPoint=ii.getCenterPoint(),tiEchelon=null,echelonBounds=null,amBounds=null,buffer=null,ctx=null,offsetX=0,offsetY=0,symStd=modifiers[MilStdAttributes.SymbologyStandard];var mobilityBounds=null;var shapes=new Array();if(symbolID.charAt(10)===("M")||symbolID.charAt(10)===("N"))
{var x=0,y=0,centerX=0,bottomY=0,height=0,width=0,middleY=0,wheelOffset=1,wheelSize=5,rrHeight=5,rrArcWidth=8;var mobility=symbolID.substring(10,12);x=symbolBounds.getX()+1;y=symbolBounds.getY();height=Math.round(symbolBounds.getHeight());width=Math.round(symbolBounds.getWidth())-1;bottomY=y+height+2;if(symbolID.charAt(10)===("M")){wheelSize=width/7;rrHeight=width/7;switch(mobility)
...
{modifierValue=null;var xm=null,ym=null;if(modifiers.X)
xm=modifiers.X;if(modifiers.Y)
...
jm=modifiers[ModifiersUnits.J_EVALUATION_RATING];if(modifiers.K)
km=modifiers[ModifiersUnits.K_COMBAT_EFFECTIVENESS];if(modifiers.L)
lm=modifiers[ModifiersUnits.L_SIGNATURE_EQUIP];if(modifiers.N)
nm=modifiers[ModifiersUnits.N_HOSTILE];if(modifiers.P)
...
E=modifiers[ModifiersUnits.E_FRAME_SHAPE_MODIFIER];if(modifiers.F)
...
if(render===true)
{var currentAlpha=1;if(frame!==null&&frame!=="")
{if(outlineOffset>0)
...
yPosition=0.39;else
yPosition=0.39;}
return yPosition;},createDOMArrowPoints:function(symbolID,bounds,center,angle,isY){var arrowPoints=new Array();var pt1=null,pt2=null,pt3=null;var length=40;if(SymbolUtilities.isNBC(symbolID))
...
{var basic=SymbolUtilities.getBasicSymbolIDStrict(symbolID);var sd=SymbolDefTable.getSymbolDef(basic,symStd);if(sd.modifiers&&sd.modifiers!=="")
...
var ii=TacticalGraphicIconRenderer.getIcon(symbolID,size,lineColor,alpha);return ii;}
