...
sec.sun.awt.geom.Order2=function()
{
    ...
    //Clazz.load (null, "sec.sun.awt.geom.Order2", ["sec.sun.awt.geom.Curve"], function () {
...
};//, "sec.sun.awt.geom.Vector,~N,~N,~N,~N,~N,~N,~N");
...
};//, "sec.sun.awt.geom.Vector,~A,~N,~N,~N,~N,~N,~N,~N");
