...
sec.sun.awt.geom.SomeOp=function()
{
    ...
    //Clazz.load (null, "sec.sun.awt.geom.SomeOp", ["java.lang.InternalError", "sec.sun.awt.geom.Arrays", "$.ChainEnd", "$.CurveLink", "$.CurveObject", "$.Edge", "$.Vector"], function () {
    ...
    //Clazz.defineMethod (c$, "newClassification", 
...
sec.sun.awt.geom.SomeOp.addEdges = function (edges, curves, curvetag) 
{
    ...
    while (enum_.hasMoreElements ()) 
    {
        ...
        if (Clazz.instanceOf (obj, sec.sun.awt.geom.CurveObject)) c = obj;
        else c =  new sec.sun.awt.geom.CurveObject (obj);
        if (c.getOrder () > 0) 
        {
