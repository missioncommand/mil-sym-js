...
org.gavaghan.geodesy.GeodeticCalculator=function()
{
    ...
    //Clazz.load (null, "org.gavaghan.geodesy.GeodeticCalculator", ["java.lang.Double", "$.RuntimeException", "org.gavaghan.geodesy.Angle", "$.Ellipsoid", "$.GeodeticCurve", "$.GeodeticMeasurement", "$.GlobalCoordinates"], function () {
    //    c$ = Clazz.decorateAsClass (function () {
    this.TwoPi = 6.283185307179586;
    //        Clazz.instantialize (this, arguments);
    //    }, org.gavaghan.geodesy, "GeodeticCalculator");
    //    Clazz.defineMethod (c$, "calculateEndingGlobalCoordinates2", 
    //    this.calculateEndingGlobalCoordinates2=function (ellipsoid, start, startBearing, distance, endBearing) {
    ...
    //Clazz.defineMethod (c$, "calculateEndingGlobalCoordinates", 
    ...
    //Clazz.defineMethod (c$, "calculateGeodeticCurve", 
    this.calculateGeodeticCurve=function (ellipsoid, start, end) {
        ...
        if (!converged) {
            ...
            if (radians < 0.0) radians += 6.283185307179586;
    ...
    //Clazz.defineMethod (c$, "calculateGeodeticMeasurement", 
