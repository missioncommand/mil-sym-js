...
armyc2.c2sd.renderer.SinglePointRenderer = (function () {
    ...
    var _statusColorMap = {"C":"#00FF00","D":"#FFFF00","X":"#FF0000","F":"#0000FF"},
        ...
        _tgTextModifierKeys = {"B":"B","C":"C","F":"F","G":"G","H":"H","H1":"H1","H2":"H2","N":"N","T":"T","T1":"T1","V":"V","W":"W","W1":"W1","XN":"XN","Y":"Y","AM":"AM","AN":"AN","Length":"Length","Width":"Width","Radius":"Radius","Angle":"Angle"};
...
return{    
	...
	//ctx.font="150pt UnitFontsC"; // * 4 (because font file is 25% of original)
        ...
        var intFill = armyc2.c2sd.renderer.utilities.UnitFontLookup.getFillCode(symbolID),
            ...
            symbol1 = String.fromCharCode(ufli.getMapping1(symbolID)),
            symbol2 = String.fromCharCode(ufli.getMapping2()),
