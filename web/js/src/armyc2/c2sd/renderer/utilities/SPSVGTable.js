...
/** @class */
armyc2.c2sd.renderer.utilities.SPSVGTable = (function () {
    ...
    return {
        ...
        init: function ()
        {
            ...
            if(map===null  && armyc2.c2sd.renderer.xml.SinglePointSVG !== undefined)
            {
                symbols = armyc2.c2sd.renderer.xml.SinglePointSVG.svg.glyph;
                armyc2.c2sd.renderer.xml.SinglePointSVG = null;
                map = {};
