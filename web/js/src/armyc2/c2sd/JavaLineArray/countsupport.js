        ...
        try {
            ...
            switch (vbiDrawThis) {
                ...
                case 23111001:
                    ...
                    for (j = 0; j < vblCounter; j++) pLowerLinePoints[j] = pLinePoints[j];

                    for (j = 0; j < vblCounter; j++) pUpperLinePoints[j] = pLinePoints[j];
                    ...
                    for (j = 0; j < vblCounter; j++) pUpperLowerLinePoints[j] = pUpperLinePoints[j];

                    for (j = 0; j < vblCounter; j++) pUpperLowerLinePoints[j + vblCounter] = pLowerLinePoints[vblCounter - j - 1];
                ...
                case 211100000:
                case 23172000:
                    if (pLinePoints.length > 1) count = armyc2.c2sd.JavaLineArray.countsupport.GetDISMFixCountDouble (pLinePoints[0], pLinePoints[1], clipBounds);
                    else count = 0;
                    break;
                case 23212000:
                    if (clipBounds != null) {
                        ...
                        if (ptsCorner != null) count = armyc2.c2sd.JavaLineArray.countsupport.GetDISMFixCountDouble (ptsCorner[0], ptsCorner[1], clipBounds);
                        else count = 20;
                    } else count = armyc2.c2sd.JavaLineArray.countsupport.GetDISMFixCountDouble (pLinePoints[0], pLinePoints[1], clipBounds);
                    break;
                default:
                    count = vblCounter;
                    break;
