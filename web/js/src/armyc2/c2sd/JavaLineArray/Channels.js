...
armyc2.c2sd.JavaLineArray.Channels=
{
        ...
        ConnectArrayTrueDouble : function (nWidth, nCounter, pLinePoints, pResultChannelPoints) {
            try {
                ...
                if (nDiff1X == 0) {
                    if (nDiff1Y > 0) nLast = 6;
                    if (nDiff1Y < 0) nLast = 4;
                }
                if (nDiff1Y == 0) {
                    if (nDiff1X > 0) nLast = 0;
                    if (nDiff1X < 0) nLast = 2;
                }
                if (nDiff1X < 0 && nDiff1Y > 0) nLast = 3;
                if (nDiff1X > 0 && nDiff1Y > 0) nLast = 0;
                if (nDiff1X < 0 && nDiff1Y < 0) nLast = 3;
                if (nDiff1X > 0 && nDiff1Y < 0) nLast = 0;
                ...
                for (nPointCounter = 1; nPointCounter < nCounter; nPointCounter++) {
                    ...
                    if (nDiff1X > 0 && nDiff2X == 0) {
                        switch (nLast) {
                            ...
                            case 4:
                            case 7:
                                if (nDiff2Y > 0) lOrient = 1;
                                if (nDiff2Y < 0) lOrient = 0;
                                break;
                            case 1:
                            case 2:
                            case 5:
                            case 6:
                                if (nDiff2Y > 0) lOrient = 2;
                                if (nDiff2Y < 0) lOrient = 3;
                                break;
                            default:
                                break;
                        }
                    ...
                    if (nDiff1X == 0 && nDiff2X > 0) {
                        switch (nLast) {
                            ...
                            case 4:
                            case 7:
                                if (nDiff1Y > 0) lOrient = 2;
                                if (nDiff1Y < 0) lOrient = 0;
                                break;
                            case 1:
                            case 2:
                            case 5:
                            case 6:
                                if (nDiff1Y > 0) lOrient = 1;
                                if (nDiff1Y < 0) lOrient = 3;
                                break;
                            default:
                                break;
                        }
            ...
            try {
                ...
                switch (vbiDrawThis) {
                    ...
                    case 231113003:
                        ...
                        if (shiftLines) {
                            if (vbiDrawThis == 231117100) pLowerLinePoints = pOriginalLinePoints;
                            ...
                            } else if (vbiDrawThis == 231117300) pUpperLinePoints = pOriginalLinePoints;
                    ...
                    case 22123001:
                        ...
                        pLowerLinePoints = armyc2.c2sd.JavaLineArray.Channels.GetChannelArray2Double (nPrinter, pLowerLinePoints, 0, vblLowerCounter, vbiDrawThis, vblChannelWidth);
                        if (shiftLines) {
                            if (armyc2.c2sd.JavaLineArray.Channels._affiliation != null && armyc2.c2sd.JavaLineArray.Channels._affiliation.equalsIgnoreCase ("H")) pLowerLinePoints = pOriginalLinePoints;
                            else pUpperLinePoints = pOriginalLinePoints;
                        }
                        ...
                        if (armyc2.c2sd.JavaLineArray.Channels.FenceType (vbiDrawThis) == 1) {
                            if (lEllipseCounter <= vblLowerCounter + vblUpperCounter) {
                                for (k = 0; k < vblLowerCounter + vblUpperCounter; k++) {
                                    if (pLinePoints[k].style != 5) pLinePoints[k].style = 0;
                                }
                            } else {
                    ...
                    case 22521411:
                        ...
                        if (vbiDrawThis == 21710000) {
                            ...
                            if (midPt1.x == midPt2.x && midPt1.y == midPt2.y) {
                                if (armyc2.c2sd.JavaLineArray.Channels._client.startsWith ("cpof")) dFeature = 30;
                                else dFeature = 15;
                                ...
                                if (armyc2.c2sd.JavaLineArray.Channels._client.startsWith ("cpof")) midPt2 = armyc2.c2sd.JavaLineArray.lineutility.ExtendLine2Double (nextToLastPoint, pArrowLinePoints[0], 20, 17);
                                else {
                                    if (dist2 > 30) midPt2 = armyc2.c2sd.JavaLineArray.lineutility.ExtendLine2Double (nextToLastPoint, pArrowLinePoints[0], 20, 17);
                                    else midPt2 = armyc2.c2sd.JavaLineArray.lineutility.ExtendLine2Double (nextToLastPoint, pArrowLinePoints[0], dFeature, 17);
                                }
                                dFeature -= 10;
                ...
                if (vbiDrawThis == 22320000 || vbiDrawThis == 22320001) {
                    for (k = 0; k < vblCounter; k++) {
                        if (pLinePoints[k].style == 2) continue ;
                        if (shape == null) shape =  new armyc2.c2sd.JavaLineArray.Shape2 (armyc2.c2sd.JavaLineArray.Shape2.SHAPE_TYPE_POLYLINE);
                        if (beginLine) {
                            if (k > 0) if (pLinePoints[k].style == 5 && pLinePoints[k - 1].style == 5) shape.lineTo (pLinePoints[k]);
                    ...
                    switch (vbiDrawThis) {
                        ...
                        case 22123000:
                            if (beginPath == false) {
                                ...
                                if (pLinePoints[k].style == 25) shape.setLineColor (armyc2.c2sd.renderer.utilities.Color.RED);
                                beginPath = false;
                            }
                            break;
                        case 21700000:
                ...
                if (fillShapes != null && fillShapes.size () > 0) shapes.addAll (0, fillShapes);
