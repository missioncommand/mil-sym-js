...
armyc2.c2sd.JavaTacticalRenderer.TGLight=function(){
    ...
    armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_H=function () {
        if (this.visibleModifiers || this.lineType == 24311000) return this.h;
        else return "";
    };
    ...
    armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_Location=function () {
        if (this.visibleModifiers) return this.y;
        else return "";
    };
    ...
    armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.get_H2=function () {
        if (this.visibleModifiers || this.lineType == 24311000) return this.h2;
        else return "";
    };
    ...
    armyc2.c2sd.JavaTacticalRenderer.TGLight.prototype.set_SymbolId=function (value) {
        try {
            ...
            if (this.symbolId.length == 15) {
                ...
                if (this.echelon.equals ("M")) this.echelonSymbol = "XXXXXX";
                else if (this.echelon.equals ("L")) this.echelonSymbol = "XXXXX";
                else if (this.echelon.equals ("K")) this.echelonSymbol = "XXXX";
                else if (this.echelon.equals ("J")) this.echelonSymbol = "XXX";
                else if (this.echelon.equals ("I")) this.echelonSymbol = "XX";
                else if (this.echelon.equals ("H")) this.echelonSymbol = "X";
                else if (this.echelon.equals ("G")) this.echelonSymbol = "III";
                else if (this.echelon.equals ("F")) this.echelonSymbol = "II";
                else if (this.echelon.equals ("E")) this.echelonSymbol = "I";
