...
armyc2.c2sd.graphics2d.Line2D.prototype.intersectsLine=function (edge) {
    ...
    {
        if (edgex1 < this.x2 && edgex2 < this.x2) return false;
        if (edgex1 > this.x1 && edgex2 > this.x1) return false;
    }
    if (this.y1 <= this.y2) 
    {
        if (edgey1 < this.y1 && edgey2 < this.y1) return false;
        if (edgey1 > this.y2 && edgey2 > this.y2) return false;
    } 
    else 
    {
        if (edgey1 < this.y2 && edgey2 < this.y2) return false;
    ...
    if (slope == edgeSlope) {
        if (b1 == b2 && rect.intersectsRect (rect2) == true) return true;
        else return false;
    } else {
        ...
        if (edgex1 < edgex2) {
            if (x < edgex1) return false;
            if (x > edgex2) return false;
        } else if (edgex2 < edgex1) {
            if (x < edgex2) return false;
            if (x > edgex1) return false;
        }
        if (edgey1 < edgey2) {
            if (y < edgey1) return false;
            if (y > edgey2) return false;
