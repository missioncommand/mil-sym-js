...
//        this.scratchCart1 = new Cartesian3();
//        this.scratchCart2 = new Cartesian3();
    _ellipsoid: undefined,
    _start: undefined,
    _end: undefined,
    _constants: undefined,
    _startHeading: undefined,
    _endHeading: undefined,
    _distance: undefined,
    _uSquared: undefined,
    scratchCart1: undefined,
    scratchCart2: undefined,
    setConstants: function (ellipsoidGeodesic) {
    ...
    computeC: function (f, cosineSquaredAlpha) {
        return f * cosineSquaredAlpha * (4.0 + f * (4.0 - 3.0 * cosineSquaredAlpha)) / 16.0;
    },
    computeDeltaLambda: function (f, sineAlpha, cosineSquaredAlpha, sigma, sineSigma, cosineSigma, cosineTwiceSigmaMidpoint) {
        var C = this.computeC(f, cosineSquaredAlpha);
    ...
    vincentyInverseFormula: function (ellipsoidGeodesic, major, minor, firstLongitude, firstLatitude, secondLongitude, secondLatitude) {
        ...
        do {
            ...
            lambda = l + this.computeDeltaLambda(eff, sineAlpha, cosineSquaredAlpha,
    ...
    computeProperties: function (ellipsoidGeodesic, start, end, ellipsoid) {
        //var firstCartesian = Cartesian3.normalize(ellipsoid.cartographicToCartesian(start, scratchCart2), scratchCart1);
        //var lastCartesian = Cartesian3.normalize(ellipsoid.cartographicToCartesian(end, scratchCart2), scratchCart2);        
        var firstCartesian = Cartesian3.normalize(ellipsoid.cartographicToCartesian(start, this.scratchCart2), this.scratchCart1);
        var lastCartesian = Cartesian3.normalize(ellipsoid.cartographicToCartesian(end, this.scratchCart2), this.scratchCart2);
        ...
        this.vincentyInverseFormula(ellipsoidGeodesic, ellipsoid.maximumRadius, ellipsoid.minimumRadius,
        ...
        this.setConstants(ellipsoidGeodesic);
    },
...
//    var scratchCart2 = new Cartesian3();
    ...
    EllipsoidGeodesic: function (start, end, ellipsoid) {
        ...
        //    this.computeProperties(this, start, end, e);
        //}
    }
};
 ...
 * @param {Cartographic} end The final planetodetic point on the path.
 */
vincenty.EllipsoidGeodesic.setEndPoints = function (start, end) {
    //>>includeStart('debug', pragmas.debug);
    if (!defined(start)) {
    ...
    this.computeProperties(this, start, end, this._ellipsoid);
};
 ...
 */
vincenty.EllipsoidGeodesic.interpolateUsingFraction = function (fraction, result) {
 ...
 */
vincenty.EllipsoidGeodesic.interpolateUsingSurfaceDistance = function (distance, result) {
    //>>includeStart('debug', pragmas.debug);
    if (!defined(this._distance)) {
    ...
    var l = lambda - this.computeDeltaLambda(constants.f, constants.sineAlpha, constants.cosineSquaredAlpha,
            sigma, sineSigma, cosineSigma, cosineTwiceSigmaMidpoint);
