...
//        }        
//    };
//    this.addAll=function ()//was location,obj 
//    {
...
//                array=array.concat(obj.getArray());                        
//            }
//        }
//        else if(arguments.length===2)
//        {
...
//    };
//    this.set=function (location, obj) {
//        array[location] = obj;
//    };
...
//            if (obj === array[j]) return true;
//        }
//        return false;
//    };
//    this.indexOf=function (obj) {
//        for (var j = 0; j < array.length; j++) {
//            if (obj === array[j]) return j;
//        }
//        return -1;
//    };
//};
...
java.util.ArrayList =  function()
{
    ...
    java.util.ArrayList.prototype.contains=function (obj) {
        for (var j = 0; j < this.array.length; j++) {
            if (obj === this.array[j]) return true;
        }
        return false;
    };
    java.util.ArrayList.prototype.indexOf=function (obj) {
        for (var j = 0; j < this.array.length; j++) {
            if (obj === this.array[j]) return j;
        }
        return -1;
    };
